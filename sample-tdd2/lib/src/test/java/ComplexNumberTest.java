...
import com.number.ComplexNumber;
...
class ComplexNumberTest {
    ...
    class Describe_of {
        ...
        @Test
        @DisplayName("of 메소드는 만약 실수값만 주어지고 허수값은 없다면 i값이 0인 복소수를 리턴한다")
        void it_returns_a_valid_complex_real() {
            final ComplexNumber2 result = ComplexNumber2.of(givenReal);

            Assertions.assertEquals(givenReal, result.getReal());
            Assertions.assertEquals(0.0, result.getImagine());
        }
